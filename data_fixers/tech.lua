...
local target_technology_name = "kr-silicon-processing"

-- Check if the technology exists
if data.raw.technology[target_technology_name] then
    -- Clear the prerequisites
    data.raw.technology[target_technology_name].prerequisites = {}
end

add_prerequisite(target_technology_name, "kr-fluids-chemistry")
