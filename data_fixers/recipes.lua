...
swap_ingredient_in_all_recipes("oxygen", "ei_oxygen-gas", excludedRecipes)
...
table.insert(data.raw.recipe["matter-tech-card"].ingredients, {"space-research-data", 15})

for i, ingredient in pairs(data.raw.recipe["matter-tech-card"].ingredients) do
    if ingredient[1] == "blank-tech-card" then
        table.remove(data.raw.recipe["matter-tech-card"].ingredients, i)
        break
    end
end
...
-- Clean up K2 Sand
recipe_swap_output("imersite-powder", "sand", modprefix.."sand")

-- Clean up matter conversion recipes
recipe_swap_output("matter-to-glass", "glass", modprefix.."glass")
recipe_swap_output("matter-to-sand", "sand", modprefix.."sand")
recipe_swap_output("matter-to-iron-ore", "iron-ore", modprefix.."pure-iron")
recipe_swap_output("matter-to-copper-ore", "copper-ore", modprefix.."pure-copper")
